...
*   **Tutorials**
    ...
    *   [Managing a busy week with calendar integration](./tutorials.md#managing-a-busy-week-with-calendar-integration)
*   **How-to Guides**
    *   [Adding a new media type](./how-to-guides.md#adding-a-new-media-type)
    *   [Implementing iCal Import](./how-to-guides.md#implementing-ical-import)
*   **Reference**
